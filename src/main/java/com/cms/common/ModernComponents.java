...
/**
 * Componenti moderni personalizzati per il CMS
 */
public class ModernComponents {

    /**
     * Crea un pulsante moderno con stile personalizzato
     */
    ...
    /**
     * Crea una card moderna con animazione di ingresso
     */
    ...
    /**
     * Crea un indicatore di caricamento moderno
     */
    ...
    /**
     * Crea una notifica toast moderna
     */
    ...
    /**
     * Crea un campo di input moderno con label flottante
     */
    public static VBox createFloatingLabelInput(String labelText, boolean isPassword) {
        ...
        input.focusedProperty().addListener((obs, oldVal, newVal) -> {
            ...
            ParallelTransition parallel = new ParallelTransition(labelTransition, labelScale);
            parallel.play();
        });
    ...
    /**
     * Crea una card statistica moderna
     */
    public static VBox createStatCard(String label, String value, String change, boolean isPositive) {
        ...
        if (change != null && !change.isEmpty()) {
            ...
            changeLabel.getStyleClass().addAll("stat-change", 
    ...
    /**
     * Crea un divisore moderno con testo
     */
